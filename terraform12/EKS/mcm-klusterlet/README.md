# IBM Cloud Pak for Multicloud Manager Klusterlet within Amazon Elastic Kubernetes Service
Copyright IBM Corp. 2020, 2020
This code is released under the Apache 2.0 License.

## Overview
This terraform template imports an existing Kubernetes cluster within the Amazon Elastic Cloud Kubernetes Service (EKS) into a IBM Cloud Pak for Multicloud Manager v1.3.1 hub-cluster.
...
## Automation summary
The terraform template performs the following activities to import the specified EKS cluster into the IBM Cloud Pak for Multicloud Manager hub-cluster:
